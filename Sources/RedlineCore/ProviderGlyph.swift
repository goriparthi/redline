// The third-party provider marks, as vector data rather than as a resource lookup.
// Generated from Resources/ProviderIcons.xcassets; ProviderGlyphTests fails if the two drift.
import SwiftUI

/// One provider mark. These are third-party marks used only to identify a provider, never as
/// RedLine's own identity; see brand/provider-glyphs/THIRD_PARTY_NOTICES.md.
public enum ProviderMark: String, CaseIterable, Sendable {
    case codex = "Codex"
    case anthropic = "Anthropic"
    case claude = "Claude"
    case ollama = "Ollama"

    /// The asset-catalog name, for the build paths that compile ProviderIcons.xcassets.
    ...
    public var accessibilityLabel: String {
        switch self {
        case .codex: return "Codex, the OpenAI coding tool"
        case .anthropic: return "Anthropic, the Claude provider"
        case .claude: return "Claude, the Anthropic product"
        case .ollama: return "Ollama, running models on this Mac"
        }
    }

    /// The mark's own SVG, exactly as the asset catalog carries it.
    public var svg: String {
        switch self {
        case .codex: return Self.codexSVG
        case .anthropic: return Self.anthropicSVG
        case .claude: return Self.claudeSVG
        case .ollama: return Self.ollamaSVG
        }
    }
